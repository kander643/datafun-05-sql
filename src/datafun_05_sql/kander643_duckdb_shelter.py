"""kander643_duckdb_shelter.py - Project script (example).
...
def main() -> None:
    ...
    try:
        ...
        # ----------------------------------------------------
        run_sql_script(con, SQL_DIR / "kander643_shelter_clean.sql")

        # ----------------------------------------------------
        # STEP 2: BOOTSTRAP (create tables, load CSV data)
        # ----------------------------------------------------
        run_sql_script(con, SQL_DIR / "kander643_shelter_bootstrap.sql")

        # ----------------------------------------------------
        # STEP 3: RUN BASIC QUERIES
        # ----------------------------------------------------
        run_sql_query(con, SQL_DIR / "kander643_shelter_query_shelter_count.sql")
        run_sql_query(con, SQL_DIR / "kander643_shelter_query_adoption_count.sql")
        run_sql_query(con, SQL_DIR / "kander643_shelter_query_adoption_aggregate.sql")
        run_sql_query(con, SQL_DIR / "kander643_shelter_query_adoption_by_category.sql")
